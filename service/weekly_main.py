...
def run_weekly_workflow():
    ...
    parser.add_argument("--project-id", type=str, default=1, help="프로젝트 ID")
    ...
    REPORTS_INPUT_DIR = os.path.join(config.PROJECT_ROOT_DIR, 'outputs')
    # 출력 디렉토리
    REPORTS_OUTPUT_DIR = os.path.join(config.PROJECT_ROOT_DIR, 'outputs', 'weekly_reports')
