...
- weekly_report_md 섹션에는 마크다운 형식의 보고서를 작성하세요. 인풋 템플릿이 존재한다면 인풋 템플릿을 참고하여 작성되어야 합니다. 이 보고서는 다음 내용을 포함해야 합니다:
  - 프로젝트명과 프로젝트 기간을 제목으로 표시
  - 팀 이름과 보고 기간을 부제목으로 표시
  - 팀 진척도 개요를 시각적으로 표현 (진행률 표시)
  - 주요 작업(highlights) 내용을 마크다운 형식의 목록으로 표현
  - 각 작업별 담당자, 진행 상황, 진척도를 포함
  - 팀 회고 및 다음 계획을 마크다운 형식으로 표현
...
### 중요!
weekly_report_md 을 뽑을때는 **프로젝트의 인풋 템플릿을 최대한 반영**하고자 노력해야함.
