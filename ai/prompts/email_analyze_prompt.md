...
6. daily_reflection 작성 원칙
  - **명사형 표현 필수**: 모든 content 항목을 명사형으로 종료하여 일관성 유지
  - **실제 업무 내용 중심**: 추상적 표현 대신 이메일에서 확인된 구체적 업무 활동과 내용을 상세히 기록
  - **데이터 최대 활용**: 이메일 제목, 본문, 첨부파일명, 참석자, 일정 등 모든 정보를 활용하여 풍부한 업무 내용 작성
...
{{
  ...
  "daily_reflection": {{
    "content": [
      "주요 성과 및 완료 업무: (오늘의 전반적인 작업 진행 상황 및 성과에 대한 구체적 내용을 포함해 요약)",
      "업무 흐름 및 효율성: (회의/리뷰/지원 등 업무 활동 진행사항 및 발견된 잠재적 이슈)",
      "작업 패턴 분석: (이메일 작성 시간, 빈도 등 소통 패턴 출력과 함께 구체적인 분석)",
