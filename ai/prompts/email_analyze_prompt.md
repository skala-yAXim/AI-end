...
2. 기타 유의사항
  ...
  - projects 정보 (예: [{{ "id": 1, "name": "프로젝트 알파", "description": "…" }}, {{ "id": 2, "name": "프로젝트 베타", "description": "…" }}, ...])는 리스트 형태로 제공될 수 있으며, 이를 email_analysis 내의 각 이메일과 WBS 작업의 project_id 및 project_name을 할당하는 데 활용합니다.
